...
export const YACHT_DICE_MODULE_VERSION = "0.0.57";
  ...
  app().innerHTML = `
    <main class="yacht-shell">
      ...
      <section class="yacht-room-layout">
        <article class="yacht-panel yacht-room-main"><p class="yacht-kicker">ROOM CODE</p><h2 class="yacht-room-code">${currentRoom.code}</h2><p>친구에게 방 코드를 알려주세요.</p><div class="yacht-rule-summary"><strong>v0.0.57 플레이 범위</strong><span>클래식 13개 점수 · 턴 순환</span><small>점수 선택 시 서버에 저장되고 다음 플레이어로 이동합니다.</small></div></article>
