...
안정성을 위해 BobArtist 서버 구현은 v0.0.59에서도 `server/src/index.ts`에 유지합니다. 향후 검증된 단계에서만 게임 모듈로 이동합니다.
...
게임 규칙과 Socket 상태 구조는 v0.0.54를 유지하며, v0.0.59는 화면 배치 안정화에 집중합니다.
