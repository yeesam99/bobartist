...
## Bob Indian Poker (v0.0.71 Blind System)

- 기본 Ante를 제거하고 Dealer / Small Blind / Big Blind 방식을 사용합니다.
- 최초 블라인드는 SB 100 / BB 200입니다.
- 10라운드마다 SB가 100, BB가 200씩 증가합니다.
- 블라인드 좌석은 매 라운드 순환하며 2인 게임은 Dealer=SB 규칙을 적용합니다.
- BB 다음 플레이어부터 행동하며, 2인 게임에서는 SB부터 행동합니다.
- 좌석에 D/SB/BB 배지를 표시하고 중앙 및 우측 패널에 현재 블라인드를 표시합니다.
- Blind, Bet, Call, Raise, All In 칩 이동과 Main/Side Pot 정산을 지원합니다.
