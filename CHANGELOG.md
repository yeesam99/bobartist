...
## v0.0.34 - Multi Runner Timer Engine

- 게임 시작 후 5분이 지나면 서버가 자동으로 RESULT 단계로 전환합니다.
- 제한시간 종료 시 술래 실패 / 도망자 승리로 처리합니다.
- 최소 2명부터 시작 가능하며, 술래 1명 + 도망자 여러 명 구조를 지원합니다.
- 최대 플레이어 수를 8명으로 확장했습니다.
- 모든 도망자가 READY 상태일 때 방장이 게임을 시작할 수 있습니다.
